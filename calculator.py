...
def show(value):
    global equation
    equation+=value
    label_result.congif(text=equation)
...
Button(root,text="=", width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda: calculate()).place(x=430,y=400)
